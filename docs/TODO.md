...
- [x] characters テーブルの UPDATE ポリシー設定（自分のデータのみ）
- [x] characters テーブルの DELETE ポリシー設定（自分のデータのみ）
- [x] character_skills テーブルの RLS を有効化
- [x] character_skills テーブルのポリシー設定（characters と同じロジック）
- [x] [CHECK] Supabase ダッシュボードでスキーマとポリシーを確認
...
- [x] [RED] Header ログインボタンのテスト作成
- [x] [GREEN] Header ログインボタン機能実装
- [x] [REFACTOR] 認証関連コードの整理
- [x] [CHECK] lint/format/build の実行と確認
...
- [x] [GREEN] 作成機能の実装
- [x] [RED] useCharacters フックの更新機能テスト作成
- [x] [GREEN] 更新機能の実装
- [x] [RED] useCharacters フックの削除機能テスト作成
- [x] [GREEN] 削除機能の実装
...
- [x] [RED] 作成ページのレンダリングテスト作成
- [x] [GREEN] 作成ページ UI 実装（src/pages/create.tsx）
- [x] [RED] フォーム送信フローのテスト作成
- [x] [GREEN] フォーム送信・リダイレクト処理実装
